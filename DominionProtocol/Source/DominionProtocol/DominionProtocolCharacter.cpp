...
ADominionProtocolCharacter::ADominionProtocolCharacter()
{
...
void ADominionProtocolCharacter::NotifyControllerChanged()
{
...
void ADominionProtocolCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ADominionProtocolCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ADominionProtocolCharacter::Look);
	}
	else
	{
...
void ADominionProtocolCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ADominionProtocolCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
